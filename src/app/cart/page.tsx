                          ...
                          <div className="flex-1 flex flex-col sm:flex-row sm:justify-between gap-3">
                            <div className="flex-1">
                              ...
                              <p className="text-xs sm:text-sm text-gray-500 font-medium mb-1">
                                {t("soldBy")} <span className="font-semibold text-[#2f2f2f]">{item.storeName || item.sellerName || t("unknown")}</span>
                              </p>
                              {item.ticketDetails?.numberOfTicket && (
                                <p className="text-xs sm:text-sm text-gray-500 font-medium mb-1">
                                  {t("totalTicketsCount")} <span className="font-semibold text-[#2f2f2f]">{item.ticketDetails.numberOfTicket}</span>
                                </p>
                              )}
                              {item.numberOfFreeTickets && (
                                <p className="text-xs sm:text-sm text-gray-500 font-medium mb-1">
                                  {t("free")} {t("tickets")}: <span className="font-semibold text-[#2f2f2f]">{item.numberOfFreeTickets}</span>
                                </p>
                              )}
                              {item.ticketCount && (
                                <p className="text-xs sm:text-sm text-gray-500 font-medium mb-2 sm:mb-2">
                                  {t("totalTicketsCount")} <span className="font-semibold text-[#2f2f2f]">{item.ticketCount}</span>
                                </p>
                              )}
                            ...
                            <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-start gap-2 sm:gap-0">
                              <button
                                ...
                                disabled={isUpdating}
                                className="p-2 text-red-600 hover:bg-red-100 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed order-2 sm:order-1 cursor-pointer"
                                aria-label={t("remove") || "Remove item"}
                              >
                                <Trash2 size={18} />
                              </button>
                              <p className="text-base sm:text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-yellow-600 order-1 sm:order-2 sm:mt-auto">
            ...
            <div className="lg:col-span-1">
              <div className="rounded-2xl shadow-[inset_0_-6px_14px_0_#00000026] p-4 xl:p-6 lg:sticky lg:top-24">
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <div className="border-t border-gray-300 pt-3 sm:pt-4 mt-3 sm:mt-4">
                    <div className="flex justify-between">
                      ...
                      <span className="text-base sm:text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-yellow-600">
                ...
                <Button
                  ...
                  className="w-full mt-4 sm:mt-6 btn-primary text-white font-bold h-11 py-4 px-4 md:px-6 rounded-lg transition-colors shadow-lg text-sm md:text-default flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
